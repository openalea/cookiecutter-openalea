...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/openalea/{{ cookiecutter.project_slug }}",
...
htmlhelp_basename = "{{cookiecutter.project_slug}}_documentation"
...
man_pages = [(master_doc, "openalea.{{ cookiecutter.project_slug}}", "{{ cookiecutter.project_name}} Documentation", [author], 1)]
